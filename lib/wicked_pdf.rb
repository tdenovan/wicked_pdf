...
class WickedPdf
  ...
  # Modifications by tdenovan to support image rendering
  # TODO: refactor this method and pdf_from_string to reuse shared code
  def image_from_string(string, options={})
    if WickedPdf.config[:retreive_version]
      retreive_binary_version
    end
